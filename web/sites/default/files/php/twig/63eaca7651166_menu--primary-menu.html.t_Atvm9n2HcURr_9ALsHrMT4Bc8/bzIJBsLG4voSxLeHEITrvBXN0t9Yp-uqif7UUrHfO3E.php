...
class __TwigTemplate_3c115957d2fe69234b64c4b6fd116c57 extends Template
{
    private $source;
    private $macros = [];
...
($context["is_top_level_menu"] ?? null) && twig_get_attribute($this->env, $this->source, $context["item"], "below", [], "any", false, false, true, 129))) ? ("primary-nav-submenu-toggle-button") : (false))]), "html", null, true);
  ...
  ";
    ...
    {
        return new Source("", "core/themes/olivero/templates/navigation/menu--primary-menu.html.twig", "/Applications/XAMPP/xamppfiles/htdocs/Drupal/testDrupal7/web/core/themes/olivero/templates/navigation/menu--primary-menu.html.twig");
    }
